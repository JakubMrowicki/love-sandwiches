...
def get_stock_values(data):
    """
    Get stock values for next market
    """
    headings = [heading for heading in SHEET.worksheet('sales').row_values(1)]
    stock_values = {headings[i]:data[i] for i in range(len(data))}
    return stock_values
